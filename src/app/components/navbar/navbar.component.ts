...
export class NavbarComponent implements OnInit {
  ...
  constructor(
    ...
    private sessionService: SessionService ) {
      ...
      this.userActive = sessionService.getSession()
  ...
  login() {
    ...
    const pass = this.form_login.value.pass

    this.usuarioService.login(username, pass).subscribe(result => {

      if (result.nombre) {

        this.userActive = result.nombre
        this.sessionService.setSession(result.nombre)
